				...
				<div class="header-user">
					<div class="nav user-menu nav-list">
							...
							<div class="sidebar-menu">	
								<div class="main-menu">
									<ul class="nav-menu">
										...
										<li class="submenu">
											<a href="#">
												<i class="ti ti-vector-triangle"></i><span>Extras</span> 
												<span class="menu-arrow"></span>
											</a>								
											<ul>								
												<li class="submenu">
												...
												<li class="submenu">
													...
													<ul>
														<li class="submenu"><a href="javascript:void(0);" class="">Login<span class="menu-arrow"></span></a>
															<ul>
														...
														<li class="submenu"><a href="javascript:void(0);" class="">Register<span class="menu-arrow"></span></a>
															<ul>
														...
														<li class="submenu"><a href="javascript:void(0);">Reset Password<span class="menu-arrow"></span></a>
															<ul>
														...
														<li class="submenu"><a href="javascript:void(0);">Email Verification<span class="menu-arrow"></span></a>
															<ul>
														...
														<li class="submenu"><a href="javascript:void(0);">2 Step Verification<span class="menu-arrow"></span></a>
															<ul>
												...
												<li class="submenu">
													...
													<ul>
														<li class="submenu">
															<a href="javascript:void(0);">Base UI
																<span class="menu-arrow"></span>
															</a>
															<ul>
										...
										<li><a href="form-pickers.html">Form Picker</a></li>
												...
												<li class="submenu">
													<a href="javascript:void(0);"><span>MultiLevel</span><span class="menu-arrow"></span></a>
													<ul>
														...
														<li class="submenu submenu-two">
															...
															<ul>
																...
																<li class="submenu submenu-two submenu-three">
																	<a href="javascript:void(0);">Multilevel 2.2<span class="menu-arrow inside-submenu inside-submenu-two"></span>
																	</a>
																	<ul>
						...
						<div class="d-flex align-items-center">
							<div class="me-1">
								<a href="#" class="btn btn-menubar" id="btnFullscreen">
				...
				<div class="d-flex align-items-center justify-content-between menu-item mb-3">
					<div class="me-3">
						<a href="#" class="btn btn-menubar position-relative">
							...
							<span class="badge bg-success rounded-pill d-flex align-items-center justify-content-center header-badge">5</span>
						</a>
					</div>
					<div class="me-3">
					...
					<ul>
							...
							<ul>
								...
								<li>
									<a href="profile-settings.html">
										<i class="ti ti-layout-sidebar"></i><span>Profile Settings</span>
									</a>
								</li>
								<li>
									<a href="gallery.html">
						...
						<li>								
							<ul>
								...
								<li><a href="404-error.html"><i class="ti ti-error-404"></i><span>404 Error</span></a></li>
								<li><a href="500-error.html"><i class="ti ti-server"></i><span>500 Error</span></a></li>
							</ul>
						</li>
						...
						<li>
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);">
										<i class="ti ti-table-plus"></i><span>Tables</span><span class="menu-arrow"></span>
									</a>
									<ul>
										<li><a href="tables-basic.html">Basic Tables </a></li>
										<li><a href="data-tables.html">Data Table </a></li>
				...
				<div class="twocol-mini">		
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist" aria-orientation="vertical">
							<a class="nav-link" title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard" aria-selected="true">
								<i class="ti ti-smart-home"></i>
							</a>
							<a class="nav-link" title="Apps" data-bs-toggle="tab" data-bs-target="#application" aria-selected="false">
								<i class="ti ti-layout-grid-add"></i>
							</a>
							<a class="nav-link active" title="Layout" data-bs-toggle="tab" data-bs-target="#layout" aria-selected="false">
								<i class="ti ti-layout-board-split"></i>
							</a>
							<a class="nav-link" title="Content" data-bs-toggle="tab" data-bs-target="#content" aria-selected="false">
								<i class="ti ti-license"></i>
							</a>
							<a class="nav-link" title="Pages" data-bs-toggle="tab" data-bs-target="#pages" aria-selected="false">
								<i class="ti ti-page-break"></i>
							</a>
							<a class="nav-link" title="UI Elements" data-bs-toggle="tab" data-bs-target="#ui-elements" aria-selected="false">
								<i class="ti ti-ux-circle"></i>
							</a>
							<a class="nav-link" title="Extras" data-bs-toggle="tab" data-bs-target="#extras" aria-selected="false">
					...
					<div class="sidebar-scroll">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="layout">
								<ul>
									<li class="menu-title"><span>LAYOUT</span></li>								
									<li class="active"><a href="layout-horizontal.html">Horizontal</a></li>
									<li><a href="layout-detached.html">Detached</a></li>
									<li><a href="layout-modern.html">Modern</a></li>
									<li><a href="layout-two-column.html">Two Column</a></li>
									<li><a href="layout-hovered.html">Hovered</a></li>
							...
							<div class="tab-pane fade" id="ui-elements">
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);">Tables
											<span class="menu-arrow"></span></a>
										<ul>
											<li><a href="tables-basic.html">Basic Tables </a></li>
											<li><a href="data-tables.html">Data Table </a></li>
					...
					<div class="sidebar-left slimscroll">
						<div class="d-flex align-items-center flex-column">
							<div class="mb-1 notification-item">
								...
								<div class="dropdown-menu notification-dropdown p-4">
									<div class="d-flex align-items-center justify-content-between border-bottom p-0 pb-3 mb-3">
										<h4 class="notification-title">Notifications (2)</h4>
										<div class="d-flex align-items-center">
											<a href="#" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
					...
					<div class="sidebar-scroll">
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
								<div class="row g-2">
									<div class="col-6">
										<a class="nav-link" title="Dashboard" data-bs-toggle="tab" data-bs-target="#menu-dashboard" aria-selected="true">
											<span><i class="ti ti-smart-home"></i></span>
											<p>Dashboard</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Apps" data-bs-toggle="tab" data-bs-target="#menu-application" aria-selected="false">									
											<span><i class="ti ti-layout-grid-add"></i></span>
											<p>Applications</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Apps" data-bs-toggle="tab" data-bs-target="#menu-superadmin" aria-selected="false">									
											<span><i class="ti ti-user-star"></i></span>
											<p>Super Admin</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Layout" data-bs-toggle="tab" data-bs-target="#menu-layout" aria-selected="false">
											<span><i class="ti ti-layout-board-split"></i></span>
											<p>Layouts</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Content" data-bs-toggle="tab" data-bs-target="#menu-content" aria-selected="false">
											<span><i class="ti ti-license"></i></span>
											<p>Contents</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Pages" data-bs-toggle="tab" data-bs-target="#menu-pages" aria-selected="false">
											<span><i class="ti ti-page-break"></i></span>
											<p>Pages</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="Authentication" data-bs-toggle="tab" data-bs-target="#menu-authentication" aria-selected="false">
											<span><i class="ti ti-lock-check"></i></span>
											<p>Authentication</p>
										</a>
									</div>
									<div class="col-6">
										<a class="nav-link" title="UI Elements" data-bs-toggle="tab" data-bs-target="#menu-ui-elements" aria-selected="false">
